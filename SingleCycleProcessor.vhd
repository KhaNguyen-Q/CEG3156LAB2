...
architecture rtl of SingleCycleProcessor is 
	...
	arithmeticUnit: ALU_8bit 
		port map(
			i_Data1 => sig_readData1, 
			i_Data2 => sig_aluMuxOut,
			ALUOp => sig_ALUOpOut, 
